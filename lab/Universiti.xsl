    ...
    <xsl:template match="/">
        <html>
            ...
            <body style="font-family: SlateForOnePlus-Medium;">
                <h1 align="center" font-family="SlateForOnePlus-Bold">University Information</h1> 
                <xsl:value-of select="/Universiti/University/navpage/@xlink:href"  xmlns:x-link="http://www.w3.org/1999/xlink"/>    
                <xsl:for-each select = "/Universiti/*">
                    <div style="background-color:#F1910F; padding:15px; border-radius:5px; margin-left: 190px; margin-right: 190px; margin-bottom: 30px;">
                        <div style="background-color:#C0750F;color:white;padding:4px; text-align: center;">
                          ...
                          <div style="margin-bottom:1em;font-size:10pt; 
                            background-color:#FAF9F8; border-bottom-right-radius:10px; 
                ...
                <h1 align="center" font-family="SlateForOnePlus-Bold">FOR ADMISSION VISIT CAMPUS</h1>
